...
class JFormFieldSwitch extends JFormField
{
	...
	protected function getInput()
	{
		...
		if (!defined ('_PARAM_HELPER')) {
			...
			$document->addScript(JURI::root(true).'/plugins/captcha/securimage/fields/jscolor/jscolor.js');
			$jversion = new JVersion();
			if( version_compare( $jversion->getShortVersion(), '3.0') >= 0 ) {
				$document->addScript(JURI::root(true).'/plugins/captcha/securimage/fields/paramhelper.js');
			}else{
				$document->addScript(JURI::root(true).'/plugins/captcha/securimage/fields/paramhelper-j25.js');
			}
			$document->addStyleSheet(JURI::root(true).'/plugins/captcha/securimage/fields/paramhelper.css');
		}
