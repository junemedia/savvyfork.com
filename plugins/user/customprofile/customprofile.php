...
class plgUserCustomProfile extends JPlugin
{
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		//11 is the id of partner
		//12 is the id of featured partner
		if(!in_array(11,$user->groups) && !in_array(12,$user->groups)){
			$form->removeField('logoimage', 'profile');
		}
		
		//Set company url field to optional for non-partners
		if(!in_array(11,$user->groups) && !in_array(12,$user->groups)){
			//$form->removeField('logoimage', 'profile');
			//$this->params->set('profile-require_companyurl', 1)
			$form->setFieldAttribute('companyurl', 'required', '', 'profile');
		}
		return true;
	}
