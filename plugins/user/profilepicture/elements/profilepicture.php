...
class JFormFieldProfilePicture extends JFormField
{
	...
	protected function getInput()
	{
		...
		if( !empty($this->value) ) {
			$path = JURI::root().'media'.DS.'plg_user_profilepicture'.DS.'images'.DS.'original'.DS.$this->value;
			$profilepicture = '<img src="'.$path.'" style="float:left;clear:left;margin:6px 0;width:180px;" />';
