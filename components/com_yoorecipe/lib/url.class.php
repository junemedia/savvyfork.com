...
class previewSubmission implements DBSaveInterface{
    private $_data = false;
...
/**
* Free form save into database
* This was used for the user manually input
*/
...
/**
* Google format to save into database
* This is the original one saving from urls
*/
...
class Model_Yoorecipe{
    ...
    * @author by Leon Zhao
    */
    private function _save_yoorecipe($userid = null){
        ...
        $insert_sql = "INSERT INTO `sf_yoorecipe` 
    ...
    private function _save_ingredients(){
        ...
        foreach($ingredients as $ingredient){
            ...
            $ingredient = mb_convert_encoding($ingredient, 'ISO-8859-1', 'UTF-8');
    ...
    public function save($userid = null)
    {
        ...
        $flag['recipe'] = $this->_save_yoorecipe($userid);
