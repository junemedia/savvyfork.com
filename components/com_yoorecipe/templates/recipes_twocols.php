...
?>
<?php if(strtoupper($item->featured) == '1' && $firstItem == 1 && $pageNum == 0 && $isHome){?>
<li style="width:434px;height:554px;">
			...
			<tr>
				<td width="90%" class="title">
					...
					<a style="font-size:17px;" href="<?php echo $details_url; ?>" id="publisher_name"><?php echo cutWord($recipe_title,46); ?></a>
						...
						if (strtoupper($item->featured) == '1' && array_search(13,$author->groups) || array_search(19,$author->groups)) {
		...
		<area target="_blank" shape="rect" coords="93,1,126,25" href="https://twitter.com/share?text=<?php echo $recipe_title;?>&url=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>" alt="" title=""  onclick="logActivity('<?php echo $user->id;?>','<?php echo $item_id;?>','Twitter')"  />
...
<li>
	<div class="cardDiv">
		...
		<div class="cardTitle">
						...
						<?php // Sponsored Label'ID on the stg site is 15
						if (array_search(13,$author->groups) || array_search(19,$author->groups)) {$sponsored = "Sponsored by";$xStyle= "margin-top: 0px;float:right;";}else {
		...
		<area target="_blank" shape="rect" coords="43,0,71,25" href="https://twitter.com/share?text=<?php echo $recipe_title;?>&url=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>" alt="" title=""  onclick="logActivity('<?php echo $user->id;?>','<?php echo $item_id;?>','Twitter')"  />
