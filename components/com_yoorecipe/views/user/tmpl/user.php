...
$blog_show_author 			= 0; //$yooRecipeparams->get('blog_show_author', 1);
...
$userLabel = ($showAuthorName == 'username') ? $this->recipeAuthor->username : $this->recipeAuthor->name;
...
<?php 
	...
	$userLabel = ($showAuthorName == 'username') ? $this->recipeAuthor->username : $this->recipeAuthor->name;
?>
<h1 class="yoorecipe-h1"><?php echo JText::_('COM_YOORECIPE_RECIPES_OF_USER'); ?>&nbsp;<?php echo htmlspecialchars($userLabel);?></h1>
...
?>
	<div>
		<input type="hidden" name="task" value="viewByUser" />
