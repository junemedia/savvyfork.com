	...
	<div id="user-part">
		<div id="partner-info">
			...
			<div class="d_info">
				...
				<?php  // Sponsored Label'ID on the stg site is 15
				if (array_search(13,$recipe_author->groups) || array_search(19,$recipe_author->groups)) { ?><font size="1">Sponsored</font><?php } ?>
			</div>
		</div>
