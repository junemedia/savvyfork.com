...
<div id="div-yoorecipe">
	...
	<div class="email_to">
		...
		<script type="text/javascript">stLight.options({publisher: "ur-ff7f3b14-df2c-9a06-45d5-350cacb1861c", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
...
<div id="div-recipe-detail">
	<div id="recipe-part" itemscope itemtype ="http://schema.org/Recipe">
		...
		<div id="div-recipe-title">
			...
			<!-- Views: <?php echo $this->recipe->nb_views; ?> -->
			<div id="recipe-img">
				...
				<div id="small-img">
					<div class="small" style="width:230px;height:250px;"><img src="<?php echo $recipe_images[1]?>" style="height:250px;"/></div>
				</div>
				<?php } else if(count($recipe_images) == 3) {?>
				<div id="big-img"><img src="<?php echo $recipe_images[0]?>" style="height:250px;"/></div>
				<div id="small-img">
					<div class="small"><img src="<?php echo $recipe_images[1]?>" style="width:230px;"/></div>
					<div class="small" style="margin-top:5px;"><img src="<?php echo $recipe_images[2]?>" style="width:230px;"/></div>
				</div>
				<?php } ?>
		...
		<div class="middleContent">
			<!--<div class="foodBlogger">
				<h3>Food Bloggers</h3>
				<?php $userGroups = $user->getAuthorisedGroups();
				...
				<div class="foodblgBtn">
					<a href="<?php echo $add_link;?>">Add Your Recipe Today!</a>
				</div>
			</div>-->
		...
		<div id="social_stats">
			<table>
				<tr class="share_tr">
					<td>
						<div><h3 class="share_recipe">Share Recipe</h3></div>
					</td>
					<td>
					...
					<td>
						<div class="share_recipe"><a title="Tweet" target="_blank" onclick="logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','Twitter')" href="https://twitter.com/share?original_referer=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>"><img src="/images/icons/color/Twitter.png" /></a></div>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="div_stats"><span><?php echo $recipe->rating;?></span></div>
					</td>
					<td>
						<div class="div_stats"><span><?php echo isset($this->socialStats[1])? $this->socialStats[1]['sharecount']:0;//echo $this->facebook_share;?></span></div>
					</td>
					<td>
						<div class="div_stats"><span><?php echo isset($this->socialStats[2])? $this->socialStats[2]['sharecount']:0;//echo $this->twitter_share; ?></span></div>
					</td>
					<td>
						<div class="div_stats"><span><?php echo isset($this->socialStats[3])? $this->socialStats[3]['sharecount']:0;//echo $this->pinterest_share;?></span></div>
					</td>
					<td>
						<div class="div_stats"><span><?php echo isset($this->socialStats[4])? $this->socialStats[4]['sharecount']:0;//echo $this->google_share;?></span></div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="stats_desc">Editor<br/>Rating</div>
					</td>
					<td>
						<div class="stats_desc">Facebook<br/>Shares</div>
					</td>
					<td>
						<div class="stats_desc">Tweets</div>
					</td>
					<td>
						<div class="stats_desc">Pinterest<br/>Pins</div>
					</td>
					<td>
						<div class="stats_desc">Google+</div>
					</td>
				</tr>
			...
			<!--<div id="share_recipe">
			<h3>Share Recipe</h3>
                <div id="social_<?php echo $item_id; ?>" >
                    <a target="_blank" onclick="logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','Facebook')" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>"><img src="/images/icons/color/Facebook.png" /></a>
                    <a target="_blank" onclick="logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','Twitter')" href="https://twitter.com/share?original_referer=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>"><img src="/images/icons/color/Twitter.png" /></a>
                    <a target="_blank" onclick="logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','Pinterest')" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>&media=http://www.savvyfork.com/<?php echo urlencode($recipe_image); ?>&description=<?php echo urlencode($recipe_title); ?>"><img src="/images/icons/color/Pinterest.png" /></a>
                    <a target="_blank" onclick="logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','Google+')" href="https://plus.google.com/share?url=<?php echo urlencode('http://www.savvyfork.com'.$details_url); ?>"><img src="/images/icons/color/Google+.png" /></a>
                </div>			
			</div>-->
		...
		<div id="directions">
			...
			<script>logActivity('<?php echo $user->id;?>','<?php echo $recipe->id;?>','FullRecipeView');</script>	<?php /* We need to track full recipe view by date so we will just log this using existing logActivity */ ?>
		</div>
	</div>
	...
	<div id="user-part">
		<div id="partner-info">
			...
			<div class="d_info">
				...
				{	$link = $author_profile->profile["companyurl"];
					?>
					<a href="http://<?php echo $link;?>" target="_blank"><img src="media/com_yoorecipe/images/earth.png" /><span><?php echo $link;?></span></a>
				<?php
				} ?><br/>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=partner&user_name='.$recipe_author->username); ?>"><img src="media/com_yoorecipe/images/search_small.png" /><span>view all <?php $recipe_count = count($this->user_recipes); echo $recipe_count;/*if($recipe_count>1) { echo $recipe_count.' recipes';} else {echo $recipe_count.' recipe';}*/?> recipes</span></a>
				</div>
				<?php if (array_search(13,$recipe_author->groups)) { ?><font size="1">Sponsored</font><?php } ?>
			</div>
		</div>
		...
		<!--<div id="recipe_stats">
			<h3>Recipe stats</h3>
			<span>Published <span class="published"><?php echo $publish_date;?></span>.</span>
			<br/>
			<span><?php echo count($recipe->saved_users)?count($recipe->saved_users):0;?> people saved this recipe.</span>
			<div id="saved_list">
			<?php if(!empty($recipe->saved_users))
			{
				foreach($recipe->saved_users as $userTmp)
				{	
					$picture = new ProfilePicture($userTmp->id);
					...
					$userGroups = JUserHelper::getUserGroups($userTmp->id);
				?>
			<a href="<?php if(in_array(11,$userGroups) || in_array(12,$userGroups)) {echo JRoute::_('index.php?option=com_users&view=partner&user_name='.$userTmp->username); } else { echo JRoute::_('index.php?option=com_users&view=userdetail&user_name='.$userTmp->username);} ?>"><img src="<?php echo $headimage?>" /></a>
			<?php	}
			}?>
		...
		<div id="more_like">		
			...
			?>
				...
				<?php }?>
				<!--<div><a href="#"><img src="images/com_yoorecipe/r2.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r3.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r4.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r5.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r6.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r7.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r8.png" /></a></div>
				<div><a href="#"><img src="images/com_yoorecipe/r9.png" /></a></div>-->
