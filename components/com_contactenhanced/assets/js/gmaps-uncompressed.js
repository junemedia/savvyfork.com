...
var ceMap = {
	...
	getDirections: function() {
		...
		ceMap.dirContainer	=	document.id('ce-directionsPanel');
	...
	init: function() {
		//Assign Field input objects to variables
		ceMap.input.lat			= document.id(ceMap.input.lat);
		ceMap.input.lng 		= document.id(ceMap.input.lng);
		ceMap.input.travelMode	= document.id(ceMap.input.travelMode);
		ceMap.input.address		= document.id(ceMap.input.address);
		ceMap.input.highways	= document.id(ceMap.input.highways);
		ceMap.input.tolls		= document.id(ceMap.input.tolls);
		ceMap.input.zoom		= document.id(ceMap.input.zoom);
		ceMap.mapCanvas			= document.id(ceMap.mapCanvas);
		...
		var ipBasedLocation	= document.id(ipBasedLocation);
