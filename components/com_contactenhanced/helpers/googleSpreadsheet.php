...
class googleSpreadsheet
{
	...
	private function login($user,$pass)
	{
		...
		if(!is_readable(JPATH_LIBRARIES.'/gdata/library/Zend/Loader.php')){
			Throw new Exception(JText::_('COM_CONTACTENHANCED_GDATA_SPREADSHEET_ERROR_MISSING_ZEND_GDATA_LIBRARY'));
		}else{
			if(!class_exists('Zend_Loader')){
				require_once (JPATH_LIBRARIES.'/gdata/library/Zend/Loader.php');
			}
			$ZendClassPath	= JPATH_LIBRARIES.'/gdata/library';
