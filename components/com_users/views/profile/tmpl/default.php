...
<?php  
        ...
        if((array_search('11',$userGroups) !== false) || (array_search('14',$userGroups) !== false)){ 
            echo "<div><button class='edit_btn'  onclick=\"window.location.href='/index.php?option=com_yoorecipe&task=import'\">Add More Recipes</button>";
            echo "&nbsp;&nbsp;&nbsp;&nbsp;<button class='edit_btn'  onclick=\"window.location.href='/index.php?option=com_users&task=partner_recipes_list'\">Edit My Photos</button>";
            echo "<div style='float:right;font-size:16px;'><b>Lost your Badge?</b> No worries, <a href='http://pics.savvyfork.com/081413-SV-elite_badge-final-white-300x200.png' target=_blank style='font-weight: bold; font-size: 16px;'>download here</a></div>
            </div>";
        } 
?>
