...
<?php foreach ($this->form->getFieldsets() as $fieldset): // Iterate through the form fieldsets and display each one.?>
	...
	<?php if (count($fields)):?>
		...
		?>
			<legend><?php if (JText::_($fieldset->label) == 'User Registration') { echo 'Join Our Community'; } else { echo JText::_($fieldset->label); }?></legend>
		<?php endif;?>
		<?php foreach ($fields as $field) :// Iterate through the fields in the set and display them.?>
		<?php if($field->fieldname == "rightbanner" || $field->fieldname =="footerbanner")
	{ echo "";}
	else{?>
...
<?php endforeach;?>
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-primary validate">Submit<?php //echo JText::_('JREGISTER');?></button>
