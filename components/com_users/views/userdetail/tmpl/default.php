...
if($this->userId)
{
	...
	if($user->id != 0)
	{
		...
		$picture = new ProfilePicture($user->id);
	...
	<div id="core_pf">
		<div class="top">
			...
			<div class="right">
				...
				<?php if (JFactory::getUser()->id == $this->userId) : ?>
