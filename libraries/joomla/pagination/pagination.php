...
class JPagination
{
	...
	protected function _list_render($list)
	{
		...
		//echo 'here';
		$html = '<table style="width:200px;border:0;align:center;margin-left:auto;margin-right:auto;">';
		//$html .= '<li class="pagination-start">' . $list['start']['data'] . '</li>';
		$html .= '<tr><td>' . $list['previous']['data'] . '</td>';
		foreach ($list['pages'] as $page)
		{
			//$html .= '<li>' . $page['data'] . '</li>';
		}
		$html .= '<td>' . $list['next']['data'] . '</td></tr>';
	...
	protected function _item_active(JPaginationObject $item)
	{
		...
		{
			if ($item->text =='Prev') {
				//return "<a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"pagenav\">" . /*$item->text*/"<img src='/images/arrow-grey-left.png' class='pagination-left'>" . "</a>";
				return "<a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"Prevpagenav\">" . $item->text . "</a>";
			}
			if ($item->text =='Next') {
				//return "<a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"pagenav\">" . /*$item->text*/"<img src='/images/arrow-grey-right.png' class='pagination-right'>" . "</a>";
				return "<a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"Nextpagenav\">" . $item->text . "</a>";
			}
		}
	}
	...
	protected function _item_inactive(JPaginationObject $item)
	{
		...
		{
			if ($item->text =='Prev') {
				//return "<span class=\"pagenav\">" . /*$item->text*/"<img src='/images/arrow-grey-left.png' class='pagination-left'>" . "</span>";
				return "";//"<span class=\"Prevpagenav\">" . $item->text . "</span>";
			}
			if ($item->text =='Next') {
				//return "<span class=\"pagenav\">" . /*$item->text*/"<img src='/images/arrow-grey-right.png' class='pagination-right'>" . "</span>";
				return "";//"<span class=\"Nextpagenav\">" . $item->text . "</span>";
			}
		}
	}
