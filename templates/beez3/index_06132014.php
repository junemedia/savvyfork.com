...
<html class="no-touch csstransitions" lang="en-US" xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	...
	<iframe src="http://matchflow-31.t.domdex.com/search.html?k=recipes,food" width="0" height="0" frameborder="0">
	<SCRIPT TYPE="text/javascript" SRC="http://loadus.exelator.com/load/?p=341&g=031&ctg=recipes&subctg=food&ag=AGE&gd=GENDER"></SCRIPT>
	...
	<script src="http://tags.crwdcntrl.net/c/1850/cc_af.js"></script>
	<script>
	LOTCC.add("int","recipes");
	LOTCC.add("int","food");
	LOTCC.bcp();
	</script>
					...
					<div class="logoheader">
						...
						<table class="header_right" id="top_table">
							...
							<tr class="header_right_bottom">
								<td>
									<?php
										//if ($menu->getActive() == $menu->getDefault() || ($option=="com_yoorecipe" && ($view == "categories" || $view == "mostrecents" || $view == "mostread" || $view == "favourites"))) {
									?>
								<div id="navmenu">
									 <jdoc:include type="modules" name="position-categories" />

										 <?php if ($_SERVER['PHP_SELF'] == '/index.php/latest' && $itemId !='') { // I know this is messy, but it's quick fix for now...If we have time before going live, then I'll correct it. ?>
											<div id="latest_btn" style="background-color:#cacaca;">
										 <?php } else { ?>
											<div id="latest_btn">
										 <?php } ?>

											 <a href="/index.php/latest<?php if($option=="com_yoorecipe" /*&& $view == "categories"*/) {echo '?catid='/*.$itemId*/;}?>">
									 ...
									 <?php if ($_SERVER['PHP_SELF'] == '/index.php/most-popular') { // I know this is messy, but it's quick fix for now...If we have time before going live, then I'll correct it. ?>
											<div id="popular_btn" style="background-color:#cacaca;">
										 <?php } else { ?>
											<div id="popular_btn">
										 <?php } ?>

											 <a href="/index.php/most-popular<?php if($option=="com_yoorecipe" /*&& $view == "categories"*/) {echo '?catid='/*.$itemId*/;}?>">
									 ...
									 <?php if ($_SERVER['PHP_SELF'] == '/index.php/editor-rating') { // I know this is messy, but it's quick fix for now...If we have time before going live, then I'll correct it. ?>
											<div id="editorrating_btn" style="background-color:#cacaca;">
										 <?php } else { ?>
											<div id="editorrating_btn">
										 <?php } ?>

											 <a href="/index.php/editor-rating<?php if($option=="com_yoorecipe" /*&& $view == "categories"*/) {echo '?catid='/*.$itemId*/;}?>">
												 <img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/personal/mostpopular.png"/>
									 ...
									 <?php if ($_SERVER['PHP_SELF'] == '/index.php/favorites') { // I know this is messy, but it's quick fix for now...If we have time before going live, then I'll correct it. ?>
				...
				<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					?>
						<div id="main" <?php echo $mainClass;?>>
							...
							<div id="top"><jdoc:include type="modules" name="position-partner"   />
								</div><?php endif; ?>
						</div><!-- end main -->
				...
				<div id="footer-inner" >
					<div id="footer-left">
						...
						<div id="followus">
							...
							<a title="Share" href="http://on.fb.me/13QG1Cw"  onmouseover="onHover('fb_img','fb-green.png');"
      onmouseout="offHover('fb_img','fb-grey.png');" target="_blank"><img id="fb_img" src="<?php echo $this->baseurl; ?>/images/fb-grey.png" alt="logo"/><span>Facebook</span></a>
	  <a title="Tweet" href="http://bit.ly/133UR9X" onmouseover="onHover('tw_img','tw-green.png');"
      onmouseout="offHover('tw_img','tw-grey.png');" target="_blank" ><img id="tw_img" src="<?php echo $this->baseurl; ?>/images/tw-grey.png" alt="logo" /><span>Twitter</span></a>
	  <a title="Pin" href="http://bit.ly/10Y7vss" onmouseover="onHover('pin_img','pin-green.png');"
      onmouseout="offHover('pin_img','pin-grey.png');" target="_blank" ><img id="pin_img" src="<?php echo $this->baseurl; ?>/images/pin-grey.png" alt="logo" /><span>Pinterest</span></a>
	  <a title="Google+" href="http://bit.ly/17Shlvw" onmouseover="onHover('google_img','google-green.png');"
      onmouseout="offHover('google_img','google-grey.png');" target="_blank" ><img id="google_img" src="<?php echo $this->baseurl; ?>/images/google-grey.png" alt="logo" /><span>Google+</span></a>
						</div>
						
						<div id="footer-sub" style="font-size:12px;"><br>
							<span>&copy; <?php echo date('Y'); ?> <a href="http://www.junemedia.com/" target="_blank" style="font-size:12px;">June Media Inc.</a> All rights reserved. All third party content &copy; their respective owners. 
							 ...
							 <a href='/subctr' style="font-size:12px;">Manage My Newsletters</a></span><br><br><br><br>
						</div>
					</div>
					<!--<div id="footer-right">
					<?php if ($option=="com_yoorecipe" && $view == "recipe") {
						...
						if(array_search(13,$recipe_author->groups)) // "Sponsored" group id is 13
						{
...
<div id="newsletter-signup-tray" align="center">
	<table align="center" width="80%" border="0">
		<tr>
			<td width="80%" style="text-align:right;" nowrap="nowrap"><iframe src="/mcapi/index.php" width="950px" frameborder="0" scrolling="No" align="center" height="50px"></iframe></td>
			<td width="20px" style="text-align:left;"><input type="button" value="Close" onclick="hideItem('newsletter-signup-tray');" id="newsletter_close" style="border:0;"></td>
		</tr>
	</table>
</div>
<script>if (readCookie('nlcookie') == 'true') { hideItem('newsletter-signup-tray'); }</script>
...
<script type="text/javascript"> try{(function(){ var s = document.createElement("script"); s.defer = true; s.src = "//tag.crsspxl.com/s1.js?d=1533"; var s0 = document.getElementsByTagName('script')[0]; s0.parentNode.insertBefore(s, s0); })();}catch(e){} </script>
...
<!-- +SWOOP -->
<script type="text/javascript" src="http://ardrone.swoop.com/js/spxw.js" data-domain="SW-10152718-6" data-serverbase="http://ardrone.swoop.com/"></script>
<!-- -SWOOP -->
