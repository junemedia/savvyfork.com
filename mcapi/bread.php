...
<html xmlns="http://www.w3.org/1999/xhtml"  >
	...
	<body style="background-image:url('http://pics.savvyfork.com/squeeze/bread.jpg');background-repeat:no-repeat;padding-top:130px;">
		 <form id="signup" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" style="padding-left:25px;">
			...
			<INPUT style="position:relative;left:129px;top:0px;width:124px;height:50px;border:none;" TYPE="image" SRC="http://pics.savvyfork.com/squeeze/button.png" BORDER="0" ALT="Submit Form" />
		</form>
		<span id="response">
		<?php
			echo $pixel;
