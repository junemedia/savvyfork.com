...
if ($_POST['submit'] == 'Enter to Win!') {
	...
	if ($message == '') {
		...
		switch (strtolower($SOURCE)) {
			...
			default:
          		$subcampid = '4374';    // SF Default Giveaway 0615
                       //$subcampid = '4364';	// SF Default Giveaway 0615
		}
		...
		$sPostingUrl = "http://sf.popularliving.com/sf_api_giveaway2.php?email=$EMAIL&sublists=$listid&subcampid=$subcampid&ipaddr=$user_ip&keycode=ggjig592fkg785kscm8473";
