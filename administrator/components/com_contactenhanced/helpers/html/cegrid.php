...
abstract class JHtmlCEGrid
{
	...
	public static function published($value, $i, $prefix = '', $enabled = true, $checkbox = 'cb', $publish_up = null, $publish_down = null)
	{
		...
		$states = array(1 => array('unpublish', 'JPUBLISHED', 'JLIB_HTML_UNPUBLISH_ITEM', 'JPUBLISHED', false, 'publish', 'publish'),
			...
			-3 => array('publish'	, 'COM_CONTACTENHANCED_OPT_WAITING_APPROVAL'	, 'COM_CONTACTENHANCED_OPT_APPROVE'		, 'COM_CONTACTENHANCED_OPT_WAITING_APPROVAL'	, false, 'waiting-approval', 'waiting-approval')
			);
