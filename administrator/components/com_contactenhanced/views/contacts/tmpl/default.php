...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_contactenhanced&task=contacts.saveOrderAjax&tmpl=component';
...
<?php 
if(count($this->items) <1 AND $this->hasContacts == 0):
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_contactenhanced&view=contacts'); ?>"
...
<?php endif;?>
			<div id="filter-bar" class="btn-toolbar">
				<div class="filter-search btn-group pull-left">
					...
					<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_CONTACTENHANCED_SEARCH_IN_NAME'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_CONTACTENHANCED_SEARCH_IN_NAME'); ?>" />
				</div>
			...
			<table class="table table-striped" id="articleList">
				<thead>
					<tr>
						...
						<th class="hidden-phone">
							<?php echo JText::_('COM_CONTACTENHANCED_FIELD_LINKED_USER_LABEL'); ?>
						</th class="hidden-phone">
						...
						<th width="5%" class="nowrap hidden-phone">
							<?php echo JHtml::_('grid.sort', 'JGLOBAL_FIELDSET_ASSOCIATIONS', 'association', $listDirn, $listOrder); ?>
						</th>
						<?php endif;?>
						<th width="5%" class="hidden-phone">
				...
				foreach ($this->items as $i => $item) :
					...
					$canEditOwn	= $user->authorise('core.edit.own',		'com_contactenhanced.category.'.$item->catid) && $item->created_by == $userId;
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
						...
						<td class="center">
							<?php echo JHtml::_('cegrid.published', $item->published, $i, 'contacts.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
						</td>
						...
						<td class="hidden-phone">
							<?php if (isset($item->association) AND  $item->association) : ?>
			...
			if(count($this->items) > 0){
				...
				echo '<h1>'.JText::_('JGLOBAL_SELECT_NO_RESULTS_MATCH').'</h1>';
			} 
			?>
