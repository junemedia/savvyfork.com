...
<fieldset class="batch">
	<legend><?php echo JText::_('COM_CONTACTENHANCED_CUSTOMFIELDS_BATCH_OPTIONS');?></legend>
	<p><?php echo JText::_('COM_CONTACTENHANCED_CUSTOMFIELDS_BATCH_TIP'); ?></p>
	...
	<button type="submit" onclick="Joomla.submitbutton('customfield.batch');">
