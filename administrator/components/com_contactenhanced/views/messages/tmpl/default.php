...
<form	enctype="multipart/form-data"
		action="<?php echo JRoute::_('index.php?option=com_contactenhanced&view=messages'); ?>"
...
<?php endif;?>
			...
			<?php
				if($this->state->get('filter.category_id')){
						...
						echo '<input type="button" value="'.JText::_('COM_CONTACTENHANCED_EXPORT_TO_CSV_FILE').'" '
								.' onclick="document.adminForm.task.value=\'messages.export\';document.adminForm.submit();"'
								.' />';
						echo ' <input type="button" value="'.JText::_('COM_CONTACTENHANCED_EXPORT_TO_XML_FILE').'" '
								.' onclick="document.adminForm.task.value=\'messages.exportXML\';document.adminForm.submit();"'
								.' />';
					}else{
						echo JText::_('JTOOLBAR_EXPORT').': <small>'.JText::_('COM_CONTACTENHANCED_SELECT_CATEGORY_FIRST').'</small>';
					}
				?>
		...
		<thead>
			<tr>
				...
				<th class="hidden-phone">
					<?php echo JText::_('CE_MSG_NAME'); ?>
				</th>

				<th class="hidden-phone">
					<?php echo JText::_('CE_MSG_EMAIL'); ?>
				</th>
				<th class="hidden-phone">
					<?php echo JText::_('CE_MSG_SUBJECT'); ?>
				</th>
				...
				<th class="hidden-phone">
					<?php echo JText::_('CE_MSG_CONTACT_NAME'); ?>
				</th>
