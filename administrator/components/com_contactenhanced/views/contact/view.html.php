<?php
/**
 * @package		com_contactenhancedenhanced
...
class ContactenhancedViewContact extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo		= contactHelper::getActions(($this->item->catid ? $this->item->catid : 0), 0);

		JToolbarHelper::title(JText::_('COM_CONTACTENHANCED_MANAGER_CONTACT'), 'contact.png');
