...
class plgContentPagenavigation extends JPlugin
{
	...
	public function onContentBeforeDisplay($context, &$row, &$params, $page=0)
	{
      ...
      $case_when1 .= $query->concatenate(array($cid, "'".$alias."'"), ':'); 
			$case_when1 .= ' ELSE ';
      ...
      $query->where('FIND_IN_SET( '. (int)$row->catid .', a.catid )  AND a.state = '. (int)$row->state .' AND a.state = ' . (int) $row->state
